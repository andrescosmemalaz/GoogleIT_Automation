...
# True if the first letter of the string is the same as the last letter of the string, False 
# if they’re different. Remember that you can access characters using message[0] or message[-1]. 
...
# "X received Y% on the exam". For example, student_grade("Reed", 80) should 
...
# to return the {n}th word from a passed sentence. For example, get_word("This is a lesson about lists", 
# 4) should return "lesson", which is the 4th word in this sentence. Hint: remember that 
